...
At time $ t $, a call option is in the money (ITM), at the money (ATM), or out
    of the money (OTM), depending on whether $ S(t) > K $, $ S(t) = K $, or
    $ S(t) < K $, respectively.
A put option is ITM, ATM, or OTM at time $ t $ if $ S(t) < K $, $ S(t) = K $, or
    $ S(t) > K $, respectively.

At maturity $ T $, a call option expires ITM, ATM, or OTM, depending on whether
    $ S(T) > K $, $ S(T) = K $, or $ S(T) < K $, respectively.
A put option expires ITM, ATM, or OTM, if $ S(T) < K $, $ S(T) = K $, or
    $ S(T) > K $, respectively.
